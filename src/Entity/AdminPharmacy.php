...
#[ORM\Entity(repositoryClass: AdminPharmacyRepository::class)]
#[UniqueEntity('Email')]
class AdminPharmacy implements UserInterface, PasswordAuthenticatedUserInterface
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    #[ORM\Column]
